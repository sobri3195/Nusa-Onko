...
export function ProjectDetailPage({ projects, onDelete, onFavorite }: { projects: Project[]; onDelete: (id: string) => void; onFavorite: (id: string) => void }) {
  ...
  if (!project) return <Card className="space-y-3"><p>Project tidak ditemukan</p><Link to="/projects" className="text-sm text-primary">Kembali ke daftar project</Link></Card>;
